...
const FacultyLogin = () => {
  ...
  const handleRegister = (e: React.FormEvent) => {
    ...
    if (!email.includes('.com')) {
      toast.error('Faculty validation failed', {
        description: 'You are not a faculty member. Faculty emails must contain .com domain.',
        duration: 5000,
      });
      return;
    }
    ...
    toast.success('Registration successful', {
      description: 'Your faculty account has been created.',
    });
  };
        ...
        <div className="w-full max-w-md">
          <div className="text-center mb-8">
            ...
            <p className="text-sm text-muted-foreground mt-2 animate-fade-in" style={{ animationDelay: '0.1s' }}>
              Access your personalized faculty dashboard
            </p>
          </div>
              ...
              <TabsContent value="register">
                <form onSubmit={handleRegister}>
                  <CardHeader>
                    ...
                    <CardDescription>
                      Create a new faculty account to manage resources and events
                    </CardDescription>
                  </CardHeader>
                  <CardContent className="space-y-4">
                    <div className="space-y-2">
                    ...
                    <div className="space-y-2">
                      ...
                      <p className="text-xs text-muted-foreground">
                        Must include .com domain (faculty validation)
                      </p>
                    </div>
                    <div className="space-y-2">
